...
class TestInvertida(unittest.TestCase):
    ...
    def test_invertida_2(self):
        ...
        imagem = pset1.Imagem(4,1,[29, 89, 136, 200])        # É feito a imagem solicitada.
        resultado = imagem.invertida()                                          # Aplicamos a função de Invertida.
        esperado = pset1.Imagem(4,1,[226, 166, 119, 55])     # Esperamos os subitrair 255 dos pixels.
        self.assertEqual(resultado, esperado)      # Compara o Vetor Atual com o Resultado Esperado
